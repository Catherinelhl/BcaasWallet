...
//        walletEntity.addStringProperty("password");//当前账户是否需要重新登入的凭证
        ...
        Entity ANClientIpInEntity = schema.addEntity("ANClientIpInfo");
        ANClientIpInEntity.addIdProperty();
        ANClientIpInEntity.addStringProperty("macAddressExternalIp");
        ANClientIpInEntity.addStringProperty("externalIp");
        ANClientIpInEntity.addStringProperty("internalIp");
        ANClientIpInEntity.addStringProperty("clientType");
        ANClientIpInEntity.addIntProperty("externalPort");
        ANClientIpInEntity.addIntProperty("internalPort");
        ANClientIpInEntity.addStringProperty("virtualCoin");
        ANClientIpInEntity.addIntProperty("rpcPort");
